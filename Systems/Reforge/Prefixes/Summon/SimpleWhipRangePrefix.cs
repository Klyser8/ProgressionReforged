...
public abstract class SimpleWhipRangePrefix(int level,
        string chainKey,
        float whipRangeMult = 1.00f,
    ...
    : WhipRangePrefix(level, chainKey)
{
    ...
    public override float WhipRangeMult => whipRangeMult;
